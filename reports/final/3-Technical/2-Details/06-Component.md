...
the Exchange Server, rather than directly to other components, and the Exchange Server 
...
persisted objects are events and device metadata. The application layer is responsible for carrying 
out the business logic of the application and providing an interface to retrieve data. In the Aria 
system, this includes autonomous control of devices using machine learning.
