...
class TestTimerDevice (TestCase):
    ...
    def test_timer_should_generate_event_after_time (self, mock_datetime):
        ...
        timer.tick()
        eventCallback.assert_called_with(mock_datetime.datetime.now.return_value)

    def test_timer_should_not_generate_event_if_time_has_not_passed (self, mock_datetime):
        mock_datetime.datetime.now.return_value = datetime.datetime.fromtimestamp(1479659949)
